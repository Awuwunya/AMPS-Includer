		...
		static void Main(string[] args) {
			if(args.Length < 3) {
				Console.Write(
					...
					"<assembler> :    The assembler being targeted, either AS, ASM68K or VASM\n"+
			...
			string set = new string[] { "=", ":=", "set" }[assembler];
			string equ = new string[] { "equ", "=", "=" }[assembler];
			string include = new string[] { "include", "include", "include" }[assembler];
			string even = new string[] { "even", "align 2", "even" }[assembler];
